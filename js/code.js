...
button[1].addEventListener("click", seven);
button[2].addEventListener("click", eight);
button[3].addEventListener("click", nine);
button[4].addEventListener("click", multiplication);
button[5].addEventListener("click", four);
button[6].addEventListener("click", five);
button[7].addEventListener("click", six);
button[8].addEventListener("click", division);
button[9].addEventListener("click", one);
button[10].addEventListener("click", two);
button[11].addEventListener("click", three);
button[12].addEventListener("click", subtraction);
button[13].addEventListener("click", period);
button[14].addEventListener("click", zero);
button[15].addEventListener("click", addition);
button[16].addEventListener("click", powerOfn);
button[17].addEventListener("click", powerOfTwo);
button[18].addEventListener("click", squareRoot);
button[19].addEventListener("click", del);
button[20].addEventListener("click", equalTo);